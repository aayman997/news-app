	...
	return (
		<div className="mb-10">
			...
			<div className="container mt-10 flex items-start gap-10">
				...
				<div
					className={clsx(
						`min-w-1/2 fixed bottom-0 left-0 top-0 z-20 -translate-x-full bg-gray-100 px-4 py-8 transition-transform duration-300 lg:static
						lg:z-0 lg:block lg:min-w-max lg:basis-1/4 lg:translate-x-0 lg:bg-transparent lg:p-0 lg:transition-none lg:duration-0`,
